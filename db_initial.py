...
def initial():
    ...
    sql = "CREATE TABLE IF NOT EXISTS Surveys (id int AUTO_INCREMENT PRIMARY KEY, email varchar(255), title varchar(255), description varchar(255), created_on int(20), expired_on int(20), surveys_id int, visibility varchar(255), unique_url varchar(255), unique_string varchar(255), status varchar(255))"
    mycursor.execute(sql)
    mydb.commit()
